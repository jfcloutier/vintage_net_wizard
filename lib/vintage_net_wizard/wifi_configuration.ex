defmodule VintageNetWizard.WiFiConfiguration do
  ...
  @type configuration() :: %{
          ...
          optional(:psk) => String.t(),
          optional(:identity) => String.t(),
          optional(:password) => String.t(),
          optional(:eap) => String.t(),
          optional(:phase2) => String.t()
        }

  alias VintageNetWizard.WiFiConfiguration.Params

  @doc """
  Make a `VintageNet` configuration from the params
  """
  @spec from_params(map()) :: {:ok, configuration()} | {:error, Params.param_error()}
  ...
  """
  @spec timeout(configuration()) :: 30_000 | 75_000
  ...
  """
  @spec get_key_mgmt(configuration()) :: key_mgmt()
  def get_key_mgmt(%{key_mgmt: key_mgmt}), do: key_mgmt

  @doc """
  Convert a key_mgmt string into a key_mgmt
  """
  @spec key_mgmt_from_string(configuration()) :: {:ok, key_mgmt()} | {:error, :invalid_key_mgmt}
  ...
  """
  @spec security_name(configuration()) :: String.t()
